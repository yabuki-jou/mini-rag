...
| M-02 文档同步 | M-01 | `docs/design/需求说明.md`、架构、数据库、API、计划 | 请假标为撤销；标书标为未实现 | 完成 |
...
`docs/implementation/智慧档案V1实施计划.md`。AV1-P01～P08、P09 确认/INDEX/取消确认、P10 清单关联/目录/审计、
P11 正式检索、P12 证据问答和 P13 物理删除实现切片已完成；P09 真实确认—INDEX/取消确认清理与 P11
单文档 P95 canary 已通过。P14 固定集复验尚不能冻结纯稠密检索阈值；真实 DeepSeek、P13 真实跨存储恢复和完整端到端验收
仍待完成。已确认以 Chroma 单机服务替换 Milvus，详见 `docs/design/Chroma迁移决策.md`；AV1-C01/C02
