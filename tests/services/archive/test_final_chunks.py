...
from app.services.archive import final_chunks as archive_final_chunk_service
...
def test_ensure_final_collection_uses_separate_cosine_collection(
    ...
    monkeypatch.setattr(archive_final_chunk_service.chroma, "get_chroma_client", lambda: client)
